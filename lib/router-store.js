...
function () {
  ...
  _createClass(RouterStore, [{
    ...
    value: function onMatch(params, rootStore, route) {
      route.isActive = true;
      var slot = typeof this.lock === 'string' ? this.lock : Array.isArray(route.slot) ? route.slot[0] : route.slot; // change currentView only when slot exists and component is not empty
    ...
    key: "push",
    value: function push(location, _ref2) {
      var _ref2$lock = _ref2.lock,
          lock = _ref2$lock === void 0 ? null : _ref2$lock;
      this.lock = lock;
