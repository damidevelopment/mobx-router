...
var startRouter = function startRouter(views, rootStore) {
  ...
  function processHistoryCallback(location, action) {
    ...
    return fns.reduce(function (promiseChain, currentTask) {
  ...
  history.subscribe(function (location, action) {
    ...
    historyStack = makeQuerablePromise(historyStack.then(function () {
      return new Promise(function (resolve) {
        return processHistoryCallback(location, action).then(resolve, resolve);
      });
    }));
